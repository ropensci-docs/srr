...
Think `srr` is useful? Let others discover it, by telling them in
...
on GitHub](https://github.com/ropensci-review-tools/srr/issues/new).
...
GitHub](https://github.com/ropensci-review-tools/srr/issues/new) so we
can fix it. A good bug report makes it easier for us to do so, so
please:
...
issue](https://github.com/ropensci-review-tools/srr/issues/new) and we
...
The `srr` coding style diverges somewhat from [the commonly used
...
code readability. Code references in `srr` are separated by whitespace,
just like words of text. Just like it is easier to understand “these
three words” than “thesethreewords”, code is formatted like this:
