...
```
    ...
    ## ℹ Loading package
    ## Error in `mixed_tag_error()`:
    ## ! Standards [G1.1,G1.2,G1.3,G2.0,G2.1,RE2.2,G2.3,G1.4] are listed with
    ##   both @srrstats and @srrstatsTODO tags. Please rectify to ensure these
    ##   standards are only associated with one tag.
